...
static iree_status_t iree_hal_nl_task_driver_factory_enumerate(
...
static iree_status_t iree_hal_nl_task_driver_factory_try_create(
...
IREE_API_EXPORT iree_status_t iree_hal_nl_task_driver_module_register(
  ...
  static const iree_hal_driver_factory_t factory = {
      .self = NULL,
      .enumerate = iree_hal_nl_task_driver_factory_enumerate,
      .try_create = iree_hal_nl_task_driver_factory_try_create,
  };
